...
AddEventHandler('police:object', function()
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
        ...
        elements = {
            ...
            {label = "Bariyerler", model = 'prop_barrier_work05'},
            {label = "Tuzaklar", model = 'p_ld_stinger_s'},
            {label = "Kutular", model = 'prop_boxpile_07d'},
            {label = "Para Kutusu", model = 'hei_prop_cash_crate_half_full'},
...
rootMenuConfig =  {
...

    {
        ...
        subMenus = {"police:hapisegonder", "gsr", "police:bill", "police:frisk", "kelepcecoz", "police:ara" , "police:tasi","police:aracakoy", "police:aractancıkar", "policearac:kilitac", "policearac:aracbagla", "policearac:aracinfo", "policearac:radarac" ,"SilahBulundurmaLisans", "SilahTasimaLisans", "AvciLisans","LisansBak", "ShowPlayerLicense", "police:object",}
    },
    {
        id = "police-action",
