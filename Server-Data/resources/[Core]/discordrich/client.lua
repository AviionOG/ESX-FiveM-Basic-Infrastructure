Citizen.CreateThread(function()
	while true do
		SetDiscordAppId(800693643983061022)
		SetDiscordRichPresenceAsset('br1')
        SetDiscordRichPresenceAssetText('Helix Roleplay')
        SetDiscordRichPresenceAssetSmall('dc')
        SetDiscordRichPresenceAssetSmallText('discord.gg/GKMnbJe9ay')
		Citizen.Wait(60000)
	end
end)
Citizen.CreateThread(function()
