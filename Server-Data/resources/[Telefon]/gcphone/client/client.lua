  ...
  if GetPlayerServerId(PlayerId()) == tonumber(phoneId) then
    ESX.TriggerServerCallback('crew-phone:phone-check', function(durum)
      if durum ~= nil then
        ...
        exports['mythic_notify']:SendAlert('inform', 'Telefonunuz Çalıyor')
      end
    end)
  end
end)
...
function TooglePhone() 
  ESX.TriggerServerCallback('crew-phone:phone-check', function(durum)
    if durum ~= nil then
      ...
      exports['mythic_notify']:SendAlert('inform', 'Telefonunuz Yok.')
    end
  end)
...
if hasFocus == true then
  ...
  elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
    exports['screenshot-basic']:requestScreenshotUpload("https://discord.com/api/webhooks/841335613885382656/zJHRP46jbGwIxO6qv7QuUz_aTiwLe1K7YlUt5bgkAO_rVR4acpmObpkHdLFhH-Gs7vNl", data.field, function(data)
