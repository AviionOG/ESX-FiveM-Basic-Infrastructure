...
RegisterNUICallback('Notify', function(data, cb)
    ...
    ESX.Notify('Başarısız!', data.message, 3000, 'error')
end)
...
AddEventHandler("inventory:client:UseWeapon", function(weaponData, shootbool)
    ...
    if currentWeapon == weaponName then
        ...
        ESX.Notify('Başarılı',weaponData.label..' Silahı Beline Koydun!', 3000, 'success')
        ...
        ESX.TriggerServerCallback("weapon:server:GetWeaponAmmo", function(result)
            ...
            ESX.Notify('Başarılı',weaponData.label..' Silahı Eline  Aldın!', 3000, 'success')
...
if closestPlayer == -1 or closestPlayerDistance > 1.0 then
    ESX.Notify('Başarılı', 'Yakında Oyuncu Yok', 3000, 'error')
else
